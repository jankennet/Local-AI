...
PERFORMANCE_TIERS = {
    "4GB": [{"n_ctx": 4096, "n_batch": 128, "n_gpu_layers": 35},
            {"n_ctx": 4096, "n_batch": 64, "n_gpu_layers": 35},
            {"n_ctx": 2048, "n_batch": 64, "n_gpu_layers": 35},
            {"n_ctx": 2048, "n_batch": 32, "n_gpu_layers": 20},
            {"n_ctx": 1024, "n_batch": 32, "n_gpu_layers": 10}],
    "6GB": [{"n_ctx": 8192, "n_batch": 256, "n_gpu_layers": 35},
            {"n_ctx": 8192, "n_batch": 128, "n_gpu_layers": 35},
            {"n_ctx": 4096, "n_batch": 256, "n_gpu_layers": 35},
            {"n_ctx": 4096, "n_batch": 128, "n_gpu_layers": 35},
            {"n_ctx": 2048, "n_batch": 128, "n_gpu_layers": 30}],
    "8GB": [{"n_ctx": 16384, "n_batch": 256, "n_gpu_layers": 35},
            {"n_ctx": 16384, "n_batch": 128, "n_gpu_layers": 35},
            {"n_ctx": 8192, "n_batch": 256, "n_gpu_layers": 35},
            {"n_ctx": 8192, "n_batch": 128, "n_gpu_layers": 35},
            {"n_ctx": 4096, "n_batch": 256, "n_gpu_layers": 35},
            {"n_ctx": 4096, "n_batch": 128, "n_gpu_layers": 35},
            {"n_ctx": 4096, "n_batch": 64, "n_gpu_layers": 30},
            {"n_ctx": 2048, "n_batch": 128, "n_gpu_layers": 30},
            {"n_ctx": 2048, "n_batch": 64, "n_gpu_layers": 25},
            {"n_ctx": 2048, "n_batch": 32, "n_gpu_layers": 20}],
    "10GB": [{"n_ctx": 16384, "n_batch": 256, "n_gpu_layers": 40},
            {"n_ctx": 16384, "n_batch": 128, "n_gpu_layers": 40},
            {"n_ctx": 8192, "n_batch": 256, "n_gpu_layers": 40},
            {"n_ctx": 8192, "n_batch": 128, "n_gpu_layers": 40},
            {"n_ctx": 4096, "n_batch": 128, "n_gpu_layers": 35}],
    "12GB": [{"n_ctx": 20480, "n_batch": 256, "n_gpu_layers": 45},
            {"n_ctx": 16384, "n_batch": 256, "n_gpu_layers": 45},
            {"n_ctx": 12288, "n_batch": 256, "n_gpu_layers": 45},
            {"n_ctx": 8192, "n_batch": 256, "n_gpu_layers": 45},
            {"n_ctx": 8192, "n_batch": 128, "n_gpu_layers": 40}],
    "16GB": [{"n_ctx": 32768, "n_batch": 512, "n_gpu_layers": 99},
            {"n_ctx": 24576, "n_batch": 512, "n_gpu_layers": 99},
            {"n_ctx": 20480, "n_batch": 512, "n_gpu_layers": 99},
            {"n_ctx": 16384, "n_batch": 512, "n_gpu_layers": 99},
            {"n_ctx": 12288, "n_batch": 256, "n_gpu_layers": 99}],
    "20GB": [{"n_ctx": 32768, "n_batch": 512, "n_gpu_layers": 99},
            {"n_ctx": 24576, "n_batch": 512, "n_gpu_layers": 99},
            {"n_ctx": 20480, "n_batch": 512, "n_gpu_layers": 99},
            {"n_ctx": 16384, "n_batch": 512, "n_gpu_layers": 99}],
    "24GB": [{"n_ctx": 32768, "n_batch": 512}],
    "32GB": [{"n_ctx": 32768, "n_batch": 512}],
    "40GB": [{"n_ctx": 32768, "n_batch": 512}],
    "48GB": [{"n_ctx": 32768, "n_batch": 512}],
}
...
def get_adaptive_configs(vram_tier: str) -> list:
    """Each base n_ctx/n_batch/n_gpu_layers triple is tried twice: first with a quantized
